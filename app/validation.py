...
SET_A: list[dict] = [
    ...
    },
    {
        ...
        "expected": {
            ...
            "cost_code": "4421",
            "role": "LM - Sorter",
            "facility": "PeenyaHub_BLR",
            "location": "BLR/PEE",
            "salary": 18000,
            "must_not": ["PeenyaHub_BLR_PL"],
        },
    ...
    },
    {
        ...
        "notes": "8751 must NOT allow Prexo Delivery Executive; Myntra LM required.",
    },
    {
        "case_id": "CASE 12",
        ...
        "expected": {
            ...
            "cost_code": "4421",
            "role": "LM - Sorter",
            "facility": {"options": ["PeenyaHub_BLR"], "allow_blank": True},
            "salary": 18000,
            "must_not": ["4441"],
        },
    ...
    },
    {
        ...
        "expected": {
            ...
            "cost_code": "4441",
            "role": "FM - Sorter",
            "facility": {"options": ["PeenyaHub_BLR_PL"], "allow_blank": True},
            "salary": 18000,
            "must_not": ["4421"],
        },
        "notes": "Explicit FM must never silently flip to 4421; approximate text may resolve to the FM hub.",
    },
    {
        "case_id": "CASE 14",
    ...
    {
        "case_id": "CASE 15",
        "title": "Sorter only - Nelamangala (suffix fallback)",
        "role_text": "sorter",
        ...
        "notes": "No explicit LM/FM; hub suffix infers Last Mile.",
    },
    {
        "case_id": "CASE 16",
...
SET_B: list[dict] = [
    {
        ...
        "expected": {
            ...
            "role": "LM - Sorter", "facility": "PeenyaHub_BLR", "salary": 16000,
        },
        "notes": "'last mile sorter' must resolve to LM Sorter.",
    },
    {
        "case_id": "CASE B02",
        "title": "first mile sorter - Peenya",
        ...
        "expected": {
            ...
            "role": {"compatible_with": "4441"},
            "facility": "PeenyaHub_BLR_PL", "salary": 16000,
        },
    ...
    },
    {
        ...
        "expected": {
            "entity": "Flipkart", "operation": "Last Mile", "cost_code": "4421",
            "role": "LM - Team Leader", "facility": "PeenyaHub_BLR", "salary": 21000,
        },
    ...
    },
    {
        ...
        "expected": {
            "entity": "Flipkart", "operation": "Last Mile", "cost_code": "4421",
            "role": {"compatible_with": "4421"},
            "facility": "PeenyaHub_BLR", "salary": 18000,
        },
    ...
    {
        "case_id": "CASE B11",
        "title": "sorter - PeenyaHub_BLR_PL (suffix infer FM)",
        "role_text": "sorter",
        "hub_text": "PeenyaHub_BLR_PL",
        "salary_text": "18000",
        "tag": "Set B",
        ...
        "expected": {
            "entity": "Flipkart", "operation": "First Mile", "cost_code": "4441",
            "role": {"compatible_with": "4441"},
            "facility": "PeenyaHub_BLR_PL", "salary": 18000,
        },
    ...
    },
    {
        ...
        "expected": {
            "entity": "Flipkart", "operation": "Last Mile", "cost_code": "4421",
            "role": "LM - Sorter", "facility": {"options": ["PeenyaHub_BLR"], "allow_blank": True},
            "salary": 17500, "must_not": ["4441", "PeenyaHub_BLR_PL"],
        },
    ...
    },
    {
        ...
        "expected": {
            "entity": "Flipkart", "operation": "First Mile", "cost_code": "4441",
            "role": "FM - Sorter", "facility": {"options": ["PeenyaHub_BLR_PL"], "allow_blank": True},
            "salary": 17500, "must_not": ["4421", "PeenyaHub_BLR"],
        },
        "notes": "Explicit FM wins; never selects the LM hub; never flips to 4421.",
    },
    {
        "case_id": "CASE B15",
    ...
    },
    {
        ...
        "expected": {
            "entity": "Flipkart", "operation": "Last Mile", "cost_code": "4421",
            "role": {"compatible_with": "4421"},
            "facility": "PeenyaHub_BLR", "salary": 18500,
        },
...
SET_C: list[dict] = [
    # ── Flipkart LM / FM variants ────────────────────────────────────────────
    {
        ...
        "expected": {
            "entity": "Flipkart", "operation": "Last Mile", "cost_code": "4421",
            "role": "LM - Sorter", "facility": "PeenyaHub_BLR", "salary": 16500,
        },
        "notes": "Explicit LM sorter; 'Penya' typo -> PeenyaHub_BLR; 16.5k.",
    },
    {
        "case_id": "C02", "title": "FM sorter - Penya hub (typo)",
        "role_text": "FM sorter", "hub_text": "Penya hub", "salary_text": "16.5k",
        "tag": "Set C", "ocr_capable": True, "expect_review": False,
        "expected": {
            "entity": "Flipkart", "operation": "First Mile", "cost_code": "4441",
            "role": {"compatible_with": "4441"}, "facility": "PeenyaHub_BLR_PL",
            "salary": 16500,
        },
    ...
    },
    {
        ...
        "expected": {
            "entity": "Flipkart", "operation": "Last Mile", "cost_code": "4421",
            "role": "LM - Team Leader", "facility": "PeenyaHub_BLR", "salary": 20500,
        },
        "notes": "Alias 'team lead' -> Team Leader; ₹20,500 -> 20500.",
    },
    {
        "case_id": "C06", "title": "FM team leader - peenya",
        "role_text": "FM team leader", "hub_text": "peenya", "salary_text": "21.25k",
        "tag": "Set C", "ocr_capable": True, "expect_review": False,
        "expected": {
            "entity": "Flipkart", "operation": "First Mile", "cost_code": "4441",
            "role": {"compatible_with": "4441"}, "facility": "PeenyaHub_BLR_PL",
    ...
    {
        "case_id": "C08", "title": "first mile biker - peenya",
        "role_text": "first mile biker", "hub_text": "peenya", "salary_text": "18k",
        "tag": "Set C", "ocr_capable": True, "expect_review": False,
        "expected": {
            "entity": "Flipkart", "operation": "First Mile", "cost_code": "4441",
            "role": {"compatible_with": "4441"}, "facility": "PeenyaHub_BLR_PL",
    ...
    # ── Exact hub inference ──────────────────────────────────────────────────
    {
        "case_id": "C15", "title": "sorter - PeenyaHub_BLR_PL (exact infer FM)",
        "role_text": "sorter", "hub_text": "PeenyaHub_BLR_PL", "salary_text": "17000",
        "tag": "Set C", "ocr_capable": True, "expect_review": False,
        "expected": {
            "entity": "Flipkart", "operation": "First Mile", "cost_code": "4441",
            "role": {"compatible_with": "4441"}, "facility": "PeenyaHub_BLR_PL",
    ...
    },
    {
        ...
        "expected": {
            "entity": "Flipkart", "operation": "Last Mile", "cost_code": "4421",
            "role": "LM - Sorter", "facility": "PeenyaHub_BLR", "salary": 17000,
        },
    ...
    {
        "case_id": "C18", "title": "delivery - NelamangalaHub_BLR",
        ...
        "notes": "Exact LM hub -> LM + LM Delivery role.",
    },
    {
    ...
    {
        "case_id": "C21", "title": "LM sorter - PeenyaHub_BLR_PL (never _PL)",
        "role_text": "LM sorter", "hub_text": "PeenyaHub_BLR_PL", "salary_text": "18000",
        "tag": "Set C", "ocr_capable": True, "expect_review": False,
        "expected": {
            "entity": "Flipkart", "operation": "Last Mile", "cost_code": "4421",
            "role": "LM - Sorter",
            "facility": {"options": ["PeenyaHub_BLR"], "allow_blank": True},
            "salary": 18000, "must_not": ["PeenyaHub_BLR_PL", "4441"],
        },
        "notes": "Operation stays Last Mile; never select _PL hub.",
    },
    {
        "case_id": "C22", "title": "FM sorter - PeenyaHub_BLR (never LM hub)",
        "role_text": "FM sorter", "hub_text": "PeenyaHub_BLR", "salary_text": "18000",
        "tag": "Set C", "ocr_capable": True, "expect_review": False,
        "expected": {
            "entity": "Flipkart", "operation": "First Mile", "cost_code": "4441",
            "role": {"compatible_with": "4441"},
            "facility": {"options": ["PeenyaHub_BLR_PL"], "allow_blank": True},
            "salary": 18000, "must_not": ["PeenyaHub_BLR", "4421"],
        },
    ...
    {
        "case_id": "C30", "title": "fm sort - peenya (salary 16.75 k)",
        "role_text": "fm sort", "hub_text": "peenya", "salary_text": "salary 16.75 k",
        "tag": "Set C", "ocr_capable": True, "expect_review": False,
        "expected": {
            "entity": "Flipkart", "operation": "First Mile", "cost_code": "4441",
            "role": {"compatible_with": "4441"}, "facility": "PeenyaHub_BLR_PL",
    ...
    },
    {
        ...
        "expected": {
            "entity": "Flipkart", "operation": "Last Mile", "cost_code": "4421",
            "role": "LM - Sorter", "facility": "PeenyaHub_BLR", "salary": 18000,
        },
        "notes": "Timestamp '10:30 am' ignored.",
    },
    {
        "case_id": "C34", "title": "FM sorter - Peenya (salary + timestamp)",
        "role_text": "FM sorter", "hub_text": "Peenya", "salary_text": "salary 18.5k 11:45 am",
        "tag": "Set C", "ocr_capable": True, "expect_review": False,
        "expected": {
            "entity": "Flipkart", "operation": "First Mile", "cost_code": "4441",
            "role": {"compatible_with": "4441"}, "facility": "PeenyaHub_BLR_PL",
    ...
    # ── Role-missing / Needs Review behaviour ────────────────────────────────
    {
        ...
        "expected": {
            "entity": "Flipkart", "operation": "Last Mile", "cost_code": "4421",
            "role": "", "facility": "PeenyaHub_BLR", "salary": 18000,
            "needs_review": True,
        },
        "notes": "LM + hub but no role -> role blank / Needs Review.",
    },
    {
        "case_id": "C42", "title": "FM - Peenya (role missing)",
        "role_text": "FM", "hub_text": "Peenya", "salary_text": "18000",
        "tag": "Set C", "ocr_capable": True, "expect_review": True,
        "expected": {
            "entity": "Flipkart", "operation": "First Mile", "cost_code": "4441",
            "role": "", "facility": "PeenyaHub_BLR_PL", "salary": 18000,
            "needs_review": True,
        },
    ...
    },
    {
        ...
        "notes": "Facility evidence but role missing; operation ambiguous -> Needs Review; do not blindly choose LM/FM.",
    },
    {
    ...
    # ── Prexo validation ─────────────────────────────────────────────────────
    {
        ...
        "expected": {
            "entity": "Flipkart", "operation": "Last Mile", "cost_code": "4421",
            "role": "LM - Prexo Delivery Executive", "facility": "PeenyaHub_BLR",
            "salary": 18000,
        },
        "notes": "Prexo IS allowed for 4421 (Flipkart LM) -> role resolved, no review.",
    },
    {
        "case_id": "C48", "title": "FM prexo - Peenya (reject, not FM-compatible)",
        "role_text": "FM prexo", "hub_text": "Peenya", "salary_text": "18000",
        "tag": "Set C", "ocr_capable": True, "expect_review": True,
        "expected": {
            "entity": "Flipkart", "operation": "First Mile", "cost_code": "4441",
            "role": "", "facility": "PeenyaHub_BLR_PL", "salary": 18000,
