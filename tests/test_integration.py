...
check("4421 Nelamangala hub display is its location", "BLR/NLM" in lm)
...
check("NelamangalaHub_BLR is ambiguous (LM + _PL refs share the prefix)",
      rules.get_location_for_facility("NelamangalaHub_BLR") == "")
