...
check("4421 has LM hubs", "NelamangalaHub_BLR" in lm)
...
print("\n--- Fuzzy examples ---")
f1 = rules.fuzzy_find_hub("nelmangla", rules.get_hubs_for_cost_code("4421"))
check("4421 nelmangla -> NelamangalaHub_BLR", f1 and f1[0] == "NelamangalaHub_BLR")
f2 = rules.fuzzy_find_hub("nelmangla", rules.get_hubs_for_cost_code("4441"))
check("4441 nelmangla -> NelamangalaHub_BLR_PL", f2 and f2[0] == "NelamangalaHub_BLR_PL")
...
print("\n--- Location auto-fill ---")
check("NelamangalaHub_BLR location", rules.get_location_for_facility("NelamangalaHub_BLR") == "BLR/NLM")
check("BanaswadiMYNTRAHub_BLR location", rules.get_location_for_facility("BanaswadiMYNTRAHub_BLR") == "BLR/BNM")
